"""
Bellia - Asistente de Ventas BELLIA RAG v3.0
...
app = FastAPI(
    title="Bellia - Asistente de Ventas BELLIA",
    version="3.0.0",
    lifespan=lifespan
)
...
TTS_SUMMARY_PROMPT = """Eres Bellia, una asistente de ventas de BELLIA. Convierte la siguiente respuesta escrita en un RESUMEN HABLADO conversacional y natural.
...
def is_greeting_or_vague(message: str) -> bool:
    ...
    pharma_patterns = [
        ...
        r'bellia', r'biopro', r'bio\s*pro', r'fbio', r'f\s*bio',
        ...
        r'bellia', r'fijie', r'marcado ce', r'certificac',
...
GREETING_RESPONSE = """Soy **Bellia**, tu asistente de ventas de BELLIA. Para poder ayudarte, cuéntame qué necesitas. Por ejemplo:

- **Producto**: *"¿Qué es BioPRO y para qué sirve?"*
- **Objeción**: *"Un médico dice que es caro, ¿cómo respondo?"*
- **Argumento**: *"¿Cómo presento BELLIA a un dermatólogo?"*
...
async def websocket_chat(websocket: WebSocket):
    ...
    try:
        while True:
            ...
            # Strip wake word ("Hola Bellia") from the message
...
4. Si HAY algún dato relevante en el contexto RAG de arriba (aunque sea tangencial), úsalo — son datos verificados de BELLIA.
...
**Te puedo ayudar con:**
- [Pregunta sugerida 1 sobre productos/protocolos de BELLIA]
- [Pregunta sugerida 2]
- [Pregunta sugerida 3]"""
