/**
 * BELLIA - Orb WebGL Shader
 * Logo animado con colores corporativos y transiciones intensas
 */

(function() {
    // Colores corporativos BELLIA (para referencia en mood tint)
    const COLORS = {
...
void main() {
    ...
    // Fragment shader con colores BELLIA
...
// Paleta BELLIA con transiciones suaves y elegantes
vec3 belliaHue(float a) {
    // Colores BELLIA
...
void main() {
    ...
    // Glow central suave con colores BELLIA (más intenso en modo pequeño)
