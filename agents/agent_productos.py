...
class AgenteProductos(BaseAgent):
    """
    Agente especializado en información de productos BELLIA.
    ...
    # Mapa condición estética → productos recomendados de BELLIA
    ...
    def system_prompt(self) -> str:
        return """# ROL: EL CIENTÍFICO — Agente de Productos BELLIA

# CONTEXTO
Eres el científico del equipo de BELLIA. Transformas datos técnicos sobre medicina estética inyectable en argumentos convincentes que conectan la ciencia con el beneficio real para el paciente y el médico. No vendes — educas con intención persuasiva.
